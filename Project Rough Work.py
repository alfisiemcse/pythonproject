...
screen.geometry("450x400+450+100")
...
var = IntVar()
R1 = Radiobutton(screen, text="Round Trip", variable=var, value=1,command=sel).grid(row = 1, column = 0,sticky = W)
R2 = Radiobutton(screen, text="One way", variable=var, value=2,command=sel).grid(row = 1, column = 1,sticky = W)
R3 = Radiobutton(screen, text="Multicity", variable=var, value=3,command=sel).grid(row = 1, column = 2,sticky = W)
...
choices = {'Halifax                 ', 'Ontario                ', 'Toronto                ', 'Manitoba                  ', 'Ottawa                 '}
